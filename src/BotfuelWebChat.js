        ...
        {Object.keys(otherSettings).length > 0 && (
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: `window.botfuelSettings = ${otherSettings};`
            }}
          />
        )}
        <script
